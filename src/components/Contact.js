...
export const Contact = () => {
  ...
  return (
    <section className="bg-black/30 rounded-lg p-8 border-2 border-wow-border relative">
      {showToast && (
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="relative">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-4 rounded-lg bg-gradient-to-b from-wow-gold/20 to-transparent border border-wow-border hover:border-wow-gold transition-all duration-300 group"
          >
